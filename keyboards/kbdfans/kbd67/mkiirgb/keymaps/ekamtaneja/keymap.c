...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DEF] = LAYOUT_65_ansi_blocker( /* Base */
		QK_GESC,    KC_1,        KC_2,          KC_3,          KC_4,          KC_5,    KC_6,    KC_7,        KC_8,        KC_9,        KC_0,           KC_MINS, KC_EQL,  KC_ENT,  KC_TRNS,
		KC_TAB,     KC_Q,        KC_W,          KC_E,          KC_R,          KC_T,    KC_Y,    KC_U,        KC_I,        KC_O,        KC_P,           KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS,
		TD(FN_NUM), GUI_T(KC_A), ALT_T(KC_S),   SFT_T(KC_D),   CTL_T(KC_F),   KC_G,    KC_H,    CTL_T(KC_J), SFT_T(KC_K), ALT_T(KC_L), GUI_T(KC_SCLN), KC_QUOT,          KC_BSPC, TG(_ENG),
    ...
    [_ENG] = LAYOUT_65_ansi_blocker( /* Engrammer */
		QK_GESC,    KC_1,        KC_2,          KC_3,          KC_4,          KC_5,    KC_6,    KC_7,        KC_8,        KC_9,        KC_0,           KC_LBRC, KC_RBRC, KC_ENT,  KC_TRNS,
		KC_TAB,     KC_B,        KC_Y,          KC_O,          KC_U,          KC_QUOT, KC_SCLN, KC_L,        KC_D,        KC_W,        KC_V,           KC_Z,    KC_EQL,  KC_BSLS, KC_TRNS,
		TD(FN_NUM), GUI_T(KC_C), ALT_T(KC_I),   SFT_T(KC_E),   CTL_T(KC_A),   KC_COMM, KC_DOT,  CTL_T(KC_H), SFT_T(KC_T), ALT_T(KC_S), GUI_T(KC_N),    KC_Q,             KC_BSPC, TG(_ENG),
	...
	[_FN] = LAYOUT_65_ansi_blocker( /* FN */
		...
		KC_NO,      KC_NO,       OSM(MOD_LALT), OSM(MOD_LSFT), OSM(MOD_LCTL), KC_NO,   KC_NO,   KC_LEFT,     KC_DOWN,     KC_RGHT,     KC_NO,          KC_NO,            KC_DEL,  KC_PGDN,
